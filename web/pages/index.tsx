...
export const getStaticProps = async () => {
    ...
    // fs.writeFileSync('/Users/asadrizvi/Documents/Projects/moviesv2/web/public/res.json', JSON.stringify(movies));
    // const movies = JSON.parse(fs.readFileSync('/Users/asadrizvi/Documents/Projects/moviesv2/web/public/res.json').toString())
    return {
        props: {
